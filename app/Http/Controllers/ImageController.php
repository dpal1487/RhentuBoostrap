...
class ImageController extends Controller
{
    ...
    public function uploadCategoryImage(Request $request)
    {
        ...
        if($image) {
                $extension = $request->image->extension();
                $file_path = 'assets/image/category/categoryBanner/';
                $name = time().'_'.$request->image->getClientOriginalName();
                ...
                $smallThumbnailFolder = 'assets/image/category/categoryBanner/thumbnail/small/';
                $mediumThumbnailFolder = 'assets/image/category/categoryBanner/thumbnail/medium/';
