...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <!--end::App-->
       @include('layouts.admin.layoutbuilder')
    <!--begin::Scrolltop-->
        @include('layouts.admin.scrolltop')
    <!--end::Scrolltop-->
    <!--begin::Modals-->
         @include('layouts.admin.model')
    <!--end::Modals-->
    <!--begin::Javascript-->
    <script>
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Oct 2022 14:28:29 GMT -->
