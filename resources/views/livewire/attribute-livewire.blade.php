                    ...
                    <th class="w-1px pe-2">
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input" data-kt-check="true"
                                data-kt-check-target="#attribute_table .form-check-input" type="checkbox"
                                value="1" />
                        </div>
                    </th>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('attribute.view', ['id' => $attribute->id]) }}"
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-id="{{ $attribute->id }}"
                                        attribute-table="delete_row">Delete</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
