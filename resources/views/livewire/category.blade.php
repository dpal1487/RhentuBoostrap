        ...
        <table class="table w-100 align-middle table-row-dashed fs-6 gy-5 table-responsive" id="category_table">
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-200px">Meta Description</th>
                            ...
                            <div class="d-flex">
                                ...
                                <a href="" class="symbol symbol-50px">
                                    <span class="symbol-label"
                                        style="background-image:url({{ asset('assets/image/category/original/') }}/{{ @$category->image->name }} "></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                    <!--begin::Title-->
                        ...
                        <td>
                            <div class="d-flex">
                                <div class="ms-5">
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7 fw-bold">
                                        {{ $category->meta ? $category->meta->description : '' }} </div>
                                    <!--end::Description-->
                                </div>
                            </div>
                        </td>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    <a href="#" class="menu-link px-3" data-id="{{ $category->id }}"
                                        category-table="delete_row">Delete</a>
