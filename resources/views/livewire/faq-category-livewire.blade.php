        ...
        <div class="card-title">
            <!--begin::Search-->
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="search" name="q" class="form-control form-control-solid w-250px ps-14"
                        placeholder="Search " wire:model="searchFaqCategory"/>
                </div>
                    ...
                    <th class="w-1px pe-2">
                        <div class="form-check form-check-sm form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                data-kt-check-target="#faq_table .form-check-input" value="1" />
                        </div>
                    </th>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-5">
                                    ...
                                    <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                        faq-filter="faq_name">{{ @$faq->title }}</a>
                                    <!--end::Title-->
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('faqs.view', ['id' => $faq->id]) }}"
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    <a href="#" class="menu-link px-3" data-id="{{ $faq->id }}"
                                        faq-table="delete_row">Delete</a>
