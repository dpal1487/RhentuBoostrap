   <!--start::Card body-->
   <div class="d-flex flex-column flex-row-fluid gap-5 gap-lg-10 col-8">
   ...
   <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 col-4">
       <div class="card card-flush py-4">
           <!--begin::Card header-->
           ...
           <!--begin::Card body-->
           <div class="card-body pt-0">
               <div id="plan_conditions" data-select2-id="select2-data-kt_ecommerce_add_category_conditions">
                   <!--begin::Form group-->
                   <div class="form-group">
                       <div data-repeater-list="plan_conditions" class="d-flex flex-column gap-3">
                           <div data-repeater-item="" class="row align-items-center">
                               <!--begin::Select2-->
                               @if(@$plan->description)
                                @if(count(json_decode($plan->description))>0)
                                    @foreach (json_decode($plan->description) as $plan)
                                    <div class="fv-row col-10">
                                        <input type="text" name="description" class="form-control"
                                            placeholder="Plan Description" value="{{ @$plan->description }}" />
                                        <div class="text-muted fs-7">Plan Description is required </div>
                                    </div>
                                    @endforeach
                                @endif
                          @else
                          <div class="fv-row col-10">
                            <input type="text" name="description" class="form-control"
                                placeholder="Plan Description" value="" />
                            <div class="text-muted fs-7">Plan Description is required </div>
                        </div>
                              @endif
                               <!--end::Select2-->
